...
public class App {
    ...
    private void run() {
        System.out.println("2. feladat: A naplóban " + absenceService.countAbsences() + " bejegyzés van.");
        ...
        System.out.print("A óra sorszáma= ");
        ...
        System.out.println("A legtöbbet hiányzó tanulók: " + absenceService.getSlackerStudentNames());
